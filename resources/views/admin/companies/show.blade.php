    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">{{$company->name}}</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    ...
                    <div class="heading-elements">
                         <span class="badge badge-default badge-danger">{{$company->name}}</span>                      
                    </div>
                  </div>
                </div>
                <!-- project-info -->
                <div id="project-info" class="card-body row">
                  ...
                  <div class="project-info-count col-lg-6 col-md-6">
                    <div class="project-info-icon">
                      <h2>{{$company->products()->where('count_selled','>',0)->count()}}</h2>
                      <div class="project-info-sub-icon">
                        <span class="icon-grid"></span>
                      </div>
                    </div>
