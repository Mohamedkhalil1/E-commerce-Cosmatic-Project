    ...
    <div class="app-content content">
        <div class="content-wrapper">
            <div class="heading-elements mb-2">
                <a href="{{route('admin.shippings.create')}}" class="btn btn-success btn-sm"><i class="ft-plus white"></i> Add Shipping</a>
              </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.shippings.delete',$shipping->id)}}"
