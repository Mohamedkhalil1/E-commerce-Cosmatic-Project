            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    ...
                    <div class="heading-elements">
                         <span class="badge badge-default badge-danger">{{$category->name}}</span>                      
                    </div>
                  </div>
                </div>
                ...
                <div id="project-info" class="card-body row">
                  ...
                  <div class="project-info-count col-lg-4 col-md-6">
                    <div class="project-info-icon">
                      <h2>{{$category->categories()->whereNotNull('parent_id')->count()}}</h2>
                      <div class="project-info-sub-icon">
                        <span class="icon-grid"></span>
                      </div>
                    </div>
            ...
            <section id="dom" class="mt-3">
              <div class="row">
                  <div class="col-12">
                      <div class="card">
                          <div class="card-header">
                              <h4 class="card-title"> <span class="icon-grid"></span> SubCategories </h4>
                              <a class="heading-elements-toggle"><i
                                      class="la la-ellipsis-v font-medium-3"></i></a>
                              <div class="heading-elements">
                                  <ul class="list-inline mb-0">
