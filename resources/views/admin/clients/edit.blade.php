                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Update Client</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" value="{{$client->email}}" id="email"
                                                                    class="form-control"
                                                                    placeholder="Email"
                                                                    name="email">
                                                            @error("email")
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" value="{{$client->phone}}" class="form-control square" placeholder="Phone" aria-label="Amount (to the nearest EGP)" name="phone">
                                                        </div>
                                                        @error("email")
                                                        <span class="text-danger"> {{ $message }} </span>
                                                        @enderror
